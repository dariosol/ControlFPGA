...
set clock_125_driver {ethlink_inst|PLL|altpll_refclk2_inst|altpll_component|auto_generated|pll1|clk[0]}  

create_generated_clock -name {input_clock_125} -multiply_by 5 -divide_by 2 -source [get_pins {ethlink_inst|PLL|altpll_refclk2_inst|altpll_component|auto_generated|pll1|inclk[0]}] [get_pins $clock_125_driver]
...
create_generated_clock -source [get_pins {ethlink_inst|PLL|altpll_refclk2_inst|altpll_component|auto_generated|pll1|inclk[0]}] -multiply_by 5 -name {input_clock_250} ethlink_inst|PLL|altpll_refclk2_inst|altpll_component|auto_generated|pll1|clk[1]
#create_generated_clock -name {input_clock_250} -multiply_by 5 -divide_by 1 -source [get_pins {ethlink_inst|PLL|altpll_refclk2_inst|altpll_component|auto_generated|pll1|inclk[1]}] 
...
set_false_path -from [get_clocks {input_clock_50}] -to [get_clocks {input_clock_250}]
